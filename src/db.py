...
def delete_scheduled_run(cid, aid, rid):
	...
	try:
		...
		return False
# script to merge admin_ids/staff_ids
# import pymongo
# from pymongo import MongoClient


# client = MongoClient()
# db = client['broadway_on_demand']
...
# admin_ids = course['admin_ids']
# staff_ids = course['staff_ids']

# staff = {'staff': {}}

# # add staff_ids to total dict
# for staff_id in staff_ids:
#     staff['staff'][staff_id] = {'is_admin': False}

# # add admin_ids to total dict
# for admin_id in admin_ids:
#     staff['staff'][admin_id] = {'is_admin': True}
