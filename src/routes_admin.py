    ...
    def __init__(self, blueprint):
        ...
        def staff_add_extension(netid, cid, aid):
            ...
            for student_netid in student_netids:
                ...
                print("Schedule result:", add_or_edit_scheduled_run(cid, aid, run_id, {"run_time": ext_end, "due_time": end_str, "name": f"Extension Run - {student_netid}", "config": "{}", "roster": student_netid}, None), flush=True)
